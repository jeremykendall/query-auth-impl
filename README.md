...
Uses `$validateSignature` to ensure the request signature is valid.  If not valid, return the response generated by `$validateSignature`; If valid, return the famous mangled phrase.
...
Uses `$validateSignature` to ensure the request signature is valid.  If valid, save the new user and return the new user data; If not valid, return the response generated by `$validateSignature`.
...
2. If not valid, return the response generated by `$validateSignature`.
